...
class Record(models.Model):
    name = models.CharField(max_length=128, null=False, blank=False, verbose_name="Имя автора")
    ...
    status = models.CharField(max_length=32,null=False, blank=False,choices=status_choices, default='active' )
